...
const RegisterButton = React.forwardRef((props, ref) => {
  ...
  return <Button ref={ref} {...rest}>Register</Button>;
});
RegisterButton.displayName = "RegisterButton";

export const Header = () => {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-black/30 backdrop-blur-sm border-b border-gray-800">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          <nav aria-label="Global" className="hidden md:block">
            {/* --- YOUR NAV LINKS ARE RESTORED HERE --- */}
            <ul className="flex items-center gap-6 text-sm">
              <li><a className="flex items-center gap-2 text-gray-200 transition hover:text-white" href="#features"><FiStar /> Features</a></li>
              <li><a className="flex items-center gap-2 text-gray-200 transition hover:text-white" href="#about"><FiInfo /> About</a></li>
              <li><a className="flex items-center gap-2 text-gray-200 transition hover:text-white" href="#contact"><FiMail /> Contact</a></li>
            </ul>
          </nav>
