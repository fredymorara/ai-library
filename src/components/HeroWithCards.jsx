...
export const HeroWithCards = () => {
  ...
  return (
    <section className="relative z-10 flex min-h-[100dvh] w-full items-center bg-transparent">
      <div className="mx-auto w-full max-w-screen-xl px-4 py-24 sm:px-6 md:grid md:grid-cols-2 md:items-center md:gap-16 lg:px-8 lg:py-40">
        ...
        >
          ...
          <h1 className="text-5xl font-bold tracking-tighter text-white sm:text-6xl lg:text-7xl leading-[1.05]">
            Go Beyond <br className="hidden md:block" /> the Catalogue.
          </h1>
        ...
        <motion.div 
          ...
          className="relative mt-16 h-[480px] w-full md:mt-0"
        >
          <CardSwap
            cardDistance={80}
